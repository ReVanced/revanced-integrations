...
public class XTheme {
    ...
    public static int SearchIconColor(int original) {
        ...
        try {
            int desiredColour = context.getResources().getColor(context.getResources().getIdentifier("custom_search_color", "color", XGlobals.getPackageName()));
    ...
    public static int RefreshIconColor(int original) {
        ...
        try {
            int desiredColour = context.getResources().getColor(context.getResources().getIdentifier("custom_refresh_color", "color", XGlobals.getPackageName()));
            return desiredColour;
        } catch (Resources.NotFoundException e) {
            return original;
        }
    ...
    public static int PinnedMessageColor(int original) {
        ...
        try {
            int desiredColour = context.getResources().getColor(context.getResources().getIdentifier("custom_pinned_color", "color", XGlobals.getPackageName()));
            return desiredColour;
        } catch (Resources.NotFoundException e) {
            return original;
        }
    ...
    public static int foregroundColorOverride(int original) {
        ...
        switch (original) {
            case -16359468:
                int returnValue3 = ColorRef.color("vanced_link_text_light", -16359468).intValue();
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue3;
                }
            ...
            case -15527149:
                if (isDarkTheme()) {
                    returnValue2 = ColorRef.color("vanced_text_secondary_dark", -15527149).intValue();
                } else {
                    returnValue2 = ColorRef.color("vanced_text_primary_light", -15527149).intValue();
                }
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue2;
                }
                ...
                return returnValue2;
            case -12671233:
                int returnValue4 = ColorRef.color("vanced_link_text_dark", -12671233).intValue();
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue4;
                }
                ...
                return returnValue4;
            case -10461088:
                int returnValue5 = ColorRef.color("vanced_text_accent_light", -10461088).intValue();
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue5;
                }
                ...
                return returnValue5;
            case -5592406:
                int returnValue6 = ColorRef.color("vanced_text_accent_dark", -5592406).intValue();
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue6;
                }
            ...
            case -1:
                if (isDarkTheme()) {
                    returnValue = ColorRef.color("vanced_text_primary_dark", -1).intValue();
                } else {
                    returnValue = ColorRef.color("vanced_text_secondary_light", -1).intValue();
                }
                if (!XGlobals.debug.booleanValue()) {
                    return returnValue;
                }
