...
import static app.revanced.twitch.utils.Utils.getIdentifier;
import static app.revanced.twitch.utils.Utils.getStringId;
...
public class TwitchSettingsHooks {
    ...
    public static boolean handleSettingsCreation(AppCompatActivity base) {
        ...
        TwitchSettingsFragment fragment = new TwitchSettingsFragment();
