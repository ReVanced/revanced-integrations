...
public class ReturnYouTubeDislikeSettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        enabledPreference.setTitle(str("ryd_enable_title"));
        enabledPreference.setSummaryOn(str("ryd_enable_summary_on"));
        enabledPreference.setSummaryOff(str("ryd_enable_summary_off"));
        ...
        shortsPreference.setTitle(str("ryd_shorts_title"));
        shortsPreference.setSummaryOn(str("ryd_shorts_summary_on"));
        shortsPreference.setSummaryOff(str("ryd_shorts_summary_off"));
        ...
        percentagePreference.setTitle(str("ryd_dislike_percentage_title"));
        percentagePreference.setSummaryOn(str("ryd_dislike_percentage_summary_on"));
        percentagePreference.setSummaryOff(str("ryd_dislike_percentage_summary_off"));
        ...
        compactLayoutPreference.setTitle(str("ryd_compact_layout_title"));
        compactLayoutPreference.setSummaryOn(str("ryd_compact_layout_summary_on"));
        compactLayoutPreference.setSummaryOff(str("ryd_compact_layout_summary_off"));
        ...
        aboutCategory.setTitle(str("ryd_about"));
        ...
        aboutWebsitePreference.setTitle(str("ryd_attribution_title"));
        aboutWebsitePreference.setSummary(str("ryd_attribution_summary"));
        ...
        if (SettingsEnum.DEBUG.getBoolean()) {
            ...
            statisticsCategory.setTitle(str("ryd_statistics_category_title"));
            ...
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallResponseTimeAverage_title"));
            ...
            statisticPreference = new Preference(context);
            statisticPreference.setSelectable(false);
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallResponseTimeMin_title"));
            statisticPreference.setSummary(createMillisecondStringFromNumber(ReturnYouTubeDislikeApi.getFetchCallResponseTimeMin()));
            preferenceScreen.addPreference(statisticPreference);

            statisticPreference = new Preference(context);
            statisticPreference.setSelectable(false);
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallResponseTimeMax_title"));
            ...
            if (fetchCallTimeWaitingLast == ReturnYouTubeDislikeApi.FETCH_CALL_RESPONSE_TIME_VALUE_RATE_LIMIT) {
                fetchCallTimeWaitingLastSummary = str("ryd_statistics_getFetchCallResponseTimeLast_rate_limit_summary");
            } else {
                fetchCallTimeWaitingLastSummary = createMillisecondStringFromNumber(fetchCallTimeWaitingLast);
            }
            statisticPreference = new Preference(context);
            statisticPreference.setSelectable(false);
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallResponseTimeLast_title"));
            statisticPreference.setSummary(fetchCallTimeWaitingLastSummary);
            preferenceScreen.addPreference(statisticPreference);

            statisticPreference = new Preference(context);
            statisticPreference.setSelectable(false);
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallCount_title"));
            statisticPreference.setSummary(createSummaryText(ReturnYouTubeDislikeApi.getFetchCallCount(),
                    "ryd_statistics_getFetchCallCount_zero_summary",
                    "ryd_statistics_getFetchCallCount_non_zero_summary"));
            preferenceScreen.addPreference(statisticPreference);

            statisticPreference = new Preference(context);
            statisticPreference.setSelectable(false);
            statisticPreference.setTitle(str("ryd_statistics_getFetchCallNumberOfFailures_title"));
            statisticPreference.setSummary(createSummaryText(ReturnYouTubeDislikeApi.getFetchCallNumberOfFailures(),
                    "ryd_statistics_getFetchCallNumberOfFailures_zero_summary",
                    "ryd_statistics_getFetchCallNumberOfFailures_non_zero_summary"));
            preferenceScreen.addPreference(statisticPreference);
            ...
            statisticPreference.setSummary(createSummaryText(ReturnYouTubeDislikeApi.getNumberOfRateLimitRequestsEncountered(),
                    "ryd_statistics_getNumberOfRateLimitRequestsEncountered_zero_summary",
                    "ryd_statistics_getNumberOfRateLimitRequestsEncountered_non_zero_summary"));
            preferenceScreen.addPreference(statisticPreference);
        }
    }
    ...
    private static String createMillisecondStringFromNumber(long number) {
        return String.format(str("ryd_statistics_millisecond_text"), number);
    }
