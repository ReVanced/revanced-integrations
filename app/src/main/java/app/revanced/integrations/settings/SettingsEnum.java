...
public enum SettingsEnum {
    ...
    ADREMOVER_PAID_CONTENT_REMOVAL("revanced_adremover_paid_content", true, ReturnType.BOOLEAN, true),
    ...
    BRANDING_SHOWN("revanced_branding_watermark_enabled", true, ReturnType.BOOLEAN),
    HIDE_ENDSCREEN_CARDS("revanced_hide_endscreen_cards", false, ReturnType.BOOLEAN),
