...
public enum SettingsEnum {
    ...
    PLAYBACK_MAX_BUFFER("revanced_pref_buffer_for_playback_ms", INTEGER, 2500),
    MAX_PLAYBACK_BUFFER_AFTER_REBUFFER("revanced_pref_buffer_for_playback_after_rebuffer_ms", INTEGER, 5000),
    ...
    SB_SEEN_GUIDELINES("sb-seen-gl", BOOLEAN, FALSE, SPONSOR_BLOCK, SB_ENABLED),
    SB_SKIPPED_SEGMENTS("sb-skipped-segments", INTEGER, 0, SPONSOR_BLOCK, SB_ENABLED),
    SB_SKIPPED_SEGMENTS_TIME("sb-skipped-segments-time", LONG, 0L, SPONSOR_BLOCK, SB_ENABLED),
