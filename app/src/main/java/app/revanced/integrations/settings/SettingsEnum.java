...
public enum SettingsEnum {
    ...
    // Layout
    ALT_THUMBNAILS_STILLS("revanced_alt_thumbnails_stills", BOOLEAN, FALSE),
    ALT_THUMBNAILS_STILLS_TIME("revanced_alt_thumbnails_stills_time", INTEGER, 2, parents(ALT_THUMBNAILS_STILLS)),
    ALT_THUMBNAILS_STILLS_FAST("revanced_alt_thumbnails_stills_fast", BOOLEAN, FALSE, parents(ALT_THUMBNAILS_STILLS)),
    ALT_THUMBNAILS_DEARROW("revanced_alt_thumbnails_dearrow", BOOLEAN, false),
    ALT_THUMBNAILS_DEARROW_API_URL("revanced_alt_thumbnails_dearrow_api_url", STRING,
            "https://dearrow-thumb.ajay.app/api/v1/getThumbnail", true, parents(ALT_THUMBNAILS_DEARROW)),
    ALT_THUMBNAILS_DEARROW_CONNECTION_TOAST("revanced_alt_thumbnails_dearrow_connection_toast", BOOLEAN, TRUE, parents(ALT_THUMBNAILS_DEARROW)),
