...
public enum SettingsEnum {
    ...
    REMEMBER_PLAYBACK_RATE_LAST_SELECTED("revanced_remember_playback_rate_last_selected", true, ReturnType.BOOLEAN),
    REMEMBER_PLAYBACK_RATE_LAST_SELECTED_VALUE("revanced_remember_playback_rate_last_selected_value", 1.0f, ReturnType.FLOAT),
