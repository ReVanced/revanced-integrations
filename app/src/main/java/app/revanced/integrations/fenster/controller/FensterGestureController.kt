...
import app.revanced.integrations.fenster.misc.ScrollDistanceHelper
...
import app.revanced.integrations.fenster.misc.contains
import app.revanced.integrations.fenster.misc.toPoint
 ...
 */
class FensterGestureController(
    context: Context,
    private val fenster: FensterController
) :
