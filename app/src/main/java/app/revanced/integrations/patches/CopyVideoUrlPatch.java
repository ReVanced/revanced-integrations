...
public class CopyVideoUrlPatch {
    ...
    public static void copyUrl(boolean withTimestamp) {
        try {
            ...
            if (withTimestamp && totalSeconds > 0) {
            ...
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.S_V2 || (withTimestamp && totalSeconds > 0)) {
                ReVancedUtils.showToastShort(withTimestamp && totalSeconds > 0
