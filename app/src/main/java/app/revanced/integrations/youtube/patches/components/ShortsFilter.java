...
import static app.revanced.integrations.shared.Utils.removeViewFromParentUnderCondition;
...
public final class ShortsFilter extends Filter {
    ...
    public static void hideLikeButton(final View likeButtonView) {
        ...
        removeViewFromParentUnderCondition(Settings.HIDE_SHORTS_LIKE_BUTTON, likeButtonView);
    }

    public static void hideDislikeButton(final View dislikeButtonView) {
        removeViewFromParentUnderCondition(Settings.HIDE_SHORTS_DISLIKE_BUTTON, dislikeButtonView);
    }
