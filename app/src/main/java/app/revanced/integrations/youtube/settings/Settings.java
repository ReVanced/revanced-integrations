...
public class Settings {
    ...
    public static Setting ALT_THUMBNAIL_STILLS_TIME = new Setting("revanced_alt_thumbnail_stills_time", INTEGER, 2, getParents(ALT_THUMBNAIL_STILLS));
    public static Setting ALT_THUMBNAIL_STILLS_FAST = new Setting("revanced_alt_thumbnail_stills_fast", BOOLEAN, FALSE, getParents(ALT_THUMBNAIL_STILLS));
    ...
    public static Setting ALT_THUMBNAIL_DEARROW_CONNECTION_TOAST = new Setting("revanced_alt_thumbnail_dearrow_connection_toast", BOOLEAN, TRUE, getParents(ALT_THUMBNAIL_DEARROW));
    public static Setting CUSTOM_FILTER = new Setting("revanced_custom_filter", BOOLEAN, FALSE);
    public static Setting CUSTOM_FILTER_STRINGS = new Setting("revanced_custom_filter_strings", STRING, "", true, getParents(CUSTOM_FILTER));
    ...
    public static Setting SPOOF_APP_VERSION_TARGET = new Setting("revanced_spoof_app_version_target", STRING, "17.08.35", true, getParents(SPOOF_APP_VERSION));
    ...
    public static Setting SEEKBAR_CUSTOM_COLOR_VALUE = new Setting("revanced_seekbar_custom_color_value", STRING, "#FF0000", true, getParents(SEEKBAR_CUSTOM_COLOR));
    ...
    public static Setting DEBUG_STACKTRACE = new Setting("revanced_debug_stacktrace", BOOLEAN, FALSE, getParents(DEBUG));
    public static Setting DEBUG_PROTOBUFFER = new Setting("revanced_debug_protobuffer", BOOLEAN, FALSE, getParents(DEBUG));
    ...
    public static Setting RYD_SHORTS = new Setting("ryd_shorts", BOOLEAN, TRUE, RETURN_YOUTUBE_DISLIKE, getParents(RYD_ENABLED));
    public static Setting RYD_DISLIKE_PERCENTAGE = new Setting("ryd_dislike_percentage", BOOLEAN, FALSE, RETURN_YOUTUBE_DISLIKE, getParents(RYD_ENABLED));
    public static Setting RYD_COMPACT_LAYOUT = new Setting("ryd_compact_layout", BOOLEAN, FALSE, RETURN_YOUTUBE_DISLIKE, getParents(RYD_ENABLED));
    public static Setting RYD_TOAST_ON_CONNECTION_ERROR = new Setting("ryd_toast_on_connection_error", BOOLEAN, TRUE, RETURN_YOUTUBE_DISLIKE, getParents(RYD_ENABLED));
    ...
    public static Setting SB_CREATE_NEW_SEGMENT_STEP = new Setting("sb_create_new_segment_step", INTEGER, 150, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_VOTING_BUTTON = new Setting("sb_voting_button", BOOLEAN, FALSE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_CREATE_NEW_SEGMENT = new Setting("sb_create_new_segment", BOOLEAN, FALSE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_COMPACT_SKIP_BUTTON = new Setting("sb_compact_skip_button", BOOLEAN, FALSE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_AUTO_HIDE_SKIP_BUTTON = new Setting("sb_auto_hide_skip_button", BOOLEAN, TRUE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_TOAST_ON_SKIP = new Setting("sb_toast_on_skip", BOOLEAN, TRUE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_TOAST_ON_CONNECTION_ERROR = new Setting("sb_toast_on_connection_error", BOOLEAN, TRUE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_TRACK_SKIP_COUNT = new Setting("sb_track_skip_count", BOOLEAN, TRUE, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_SEGMENT_MIN_DURATION = new Setting("sb_min_segment_duration", FLOAT, 0F, SPONSOR_BLOCK, getParents(SB_ENABLED));
    public static Setting SB_VIDEO_LENGTH_WITHOUT_SEGMENTS = new Setting("sb_video_length_without_segments", BOOLEAN, TRUE, SPONSOR_BLOCK, getParents(SB_ENABLED));
