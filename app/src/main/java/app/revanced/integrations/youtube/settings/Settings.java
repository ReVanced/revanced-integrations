...
public class Settings extends BaseSettings {
    ...
    public static final IntegerSetting CHECK_ENVIRONMENT_WARNING_ISSUED_COUNT = new IntegerSetting("revanced_check_environment_warning_issued_count", 0, false, false);
