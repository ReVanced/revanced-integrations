...
public class Settings extends BaseSettings {
    ...
    public static final BooleanSetting SPOOF_CLIENT_USE_IOS = new BooleanSetting("revanced_spoof_client_use_ios", FALSE, true, "revanced_spoof_client_user_dialog_message", parent(SPOOF_CLIENT));
    @Deprecated
