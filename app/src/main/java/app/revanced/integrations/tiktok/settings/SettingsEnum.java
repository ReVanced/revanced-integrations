...
import static app.revanced.integrations.tiktok.settings.SettingsEnum.ReturnType.BOOLEAN;
import static app.revanced.integrations.tiktok.settings.SettingsEnum.ReturnType.STRING;
