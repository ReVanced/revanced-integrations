...
import static app.revanced.integrations.twitch.settings.SettingsEnum.ReturnType.BOOLEAN;
import static app.revanced.integrations.twitch.settings.SettingsEnum.ReturnType.STRING;
