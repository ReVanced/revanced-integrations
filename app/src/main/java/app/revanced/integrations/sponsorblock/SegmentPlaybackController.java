...
import app.revanced.integrations.patches.playback.speed.CurrentPlaybackSpeedPatch;
...
public class SegmentPlaybackController {
    ...
    public static void setVideoTime(long millis) {
        try {
            ...
            final float playbackSpeed = CurrentPlaybackSpeedPatch.getCurrentPlaybackSpeed();
